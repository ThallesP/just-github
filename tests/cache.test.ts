...
describe("ContentCache", () => {
  ...
  it("evicts oldest entries when maxBytes exceeded", () => {
    const tiny = new ContentCache({ maxBytes: 20, maxEntries: 100 });
    tiny.set("a", "12345"); // 10 bytes (string length * 2)
    tiny.set("b", "12345"); // 10 bytes — total 20
    tiny.set("c", "12345"); // 10 bytes — should evict "a"
